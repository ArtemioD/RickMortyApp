...
val BackgroundPrimaryColor
    @Composable get() = if (isSystemInDarkTheme()) PrimaryBlack else PrimaryWhite

val BackgroundSecondaryColor
    @Composable get() = if (isSystemInDarkTheme()) SecondaryBlack else SecondaryWhite
...
val PlaceholderColor
    @Composable get() = if (isSystemInDarkTheme()) TertiaryBlack else SecondaryWhite
